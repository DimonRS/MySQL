/* 1.1 Таблицы для домашнего задания №6 доп*/

-- 1. Создание БД
CREATE DATABASE IF NOT EXISTS HomeWork_6_dop; -- Создаем БД lesson1, если до этого такой БД не существовло

-- 2. Выбираем активную БД
USE HomeWork_6_dop;

/* 1.2 БД из 4 урока, ВК.
