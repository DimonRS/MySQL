/* 1.1 Таблицы для домашнего задания №6*/

-- 1. Создание БД
CREATE DATABASE IF NOT EXISTS HomeWork_6; -- Создаем БД lesson1, если до этого такой БД не существовло

-- 2. Выбираем активную БД
USE HomeWork_6;

/* 1.2 Создайте функцию, которая принимает кол-во сек и формат их в кол-во дней часов.
...
/* 1.3 Выведите только четные числа от 1 до 10.
Пример: 2,4,6,8,10 */
